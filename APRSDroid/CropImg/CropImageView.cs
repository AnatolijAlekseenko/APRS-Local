...
namespace APRSDroid.CropImg
{
    public class CropImageView : ImageViewTouchBase
    {
        ...
        private global::APRSDroid.CropImg.HighlightView.HitPosition motionEdge;
            ...
            switch (ev.Action)
            {
                case MotionEventActions.Down:
                    ...
                    for (int i = 0; i < hightlightViews.Count; i++)
                    {
                        ...
                        if (edge != global::APRSDroid.CropImg.HighlightView.HitPosition.None)
                        {
                            motionEdge = edge;
                            ...
                            mMotionHighlightView.Mode = 
                                (edge == global::APRSDroid.CropImg.HighlightView.HitPosition.Move)
